...
def add_model_args(parser):
    ...
    model.add_argument('--num-features', type=int, default=2,
                       help='Number of token features')
    model.add_argument('--context-layers', type=int, default=3,
    ...
    model.add_argument('--num-attn-head', type=int, default=4,
    ...
    detail.add_argument('--question-merge', type=str, default='learn_weight',
                        help='The way of computing the question representation')
    detail.add_argument('--question-merge-self-attn', type='bool', default=False,
                        help='Self attention on top of Question Reader')
    ...
    optim.add_argument('--layernorm-emb', type='bool', default=False,
                       help='Whether to add LayerNorm to the Embedding output')
    ...
    optim.add_argument("--learning-rate", default=0.1, type=float)
    optim.add_argument("--adam-epsilon", default=1e-8, type=float) 
    optim.add_argument("--warmup-steps", default=0, type=int)
    return parser
